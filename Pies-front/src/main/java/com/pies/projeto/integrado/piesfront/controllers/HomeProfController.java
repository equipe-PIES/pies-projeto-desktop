...
public class HomeProfController implements Initializable {
    ...
    private void atualizarIndicadorDeTela(URL url) {
        ...
        if (arquivoFXML.contains("tela-inicio-prof.fxml")) {
    ...
    private void handleInicioButtonAction() {
        try {
            Parent root = FXMLLoader.load(getClass().getResource("/com/pies/projeto/integrado/piesfront/screens/tela-inicio-prof.fxml"));

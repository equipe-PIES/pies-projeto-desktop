...
public class RelatorioIndividualService {
     ...
     * @param professorId ID do professor que está criando o relatório (obtido do contexto de segurança)
     ...
     */
    @Transactional
    public RelatorioIndividualDTO salvar(CreateRelatorioIndividualDTO dto, String professorId) {
        // Busca o educando

...
/**
 * DTO PARA CRIAÇÃO - VALIDAÇÃO DE ENTRADA
 * 
 * Este DTO é usado especificamente para criação de novos professores.
 * É enviado no corpo da requisição POST /professores.
 * 
 * Características:
 * - NÃO inclui campo 'id' (gerado automaticamente pelo banco)
 * - Contém todas as validações necessárias para garantir integridade dos dados
 * - Validações idênticas ao modelo para manter consistência
...
public class CreateProfessorDTO {
    ...
    // Validações idênticas ao modelo Professor para garantir consistência
